                ...
                <div style={{ background: 'var(--bg-color)', border: '1px solid var(--border-color)', padding: 'clamp(30px, 5vw, 50px)' }}>
                    {formState === 'success' ? (
                        ...
                        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 'clamp(24px, 4vw, 30px)' }}>
                            ...
                            <div className="input-group">
                                <label style={{ fontSize: 'clamp(0.6rem, 1vw, 0.65rem)', textTransform: 'uppercase', color: 'var(--text-muted)', letterSpacing: '0.1em', display: 'block', marginBottom: '10px' }}>Email Address</label>
                                <input
                                    required
                                    name="email"
                                    type="email"
