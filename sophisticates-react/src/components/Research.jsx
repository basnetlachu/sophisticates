...
const Research = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setStatus('sending');
        try {
            // Map to the existing /api/contact logic which sends notifications
            const res = await fetch('/api/contact', {
                ...
                body: JSON.stringify({
                    ...
                    country: form.area, // Using area as 'country/category' for compatibility
    ...
    return (
        <main className="smooth-scroll-wrapper">
            ...
            {/* Participation Form with Consistent Design */}
            <section style={{
                background: 'var(--bg-color)',
                ...
                <div className="max-w-container">
                    <div className="contact-grid" style={{
                        ...
                        {/* Form Side - Glass Panel Consistent with Contact.jsx */}
                        <motion.div
