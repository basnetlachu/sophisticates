        ...
        <section id="about" ref={ref} className="section-padding" style={{ background: 'var(--bg-color)', position: 'relative' }}>
            ...
            // About Sophisticates
                    ...
                    <div style={{
                        ...
                        <p style={{ fontSize: 'clamp(1rem, 1.8vw, 1.1rem)', color: 'var(--text-muted)', lineHeight: '1.7' }}>
                        ...
                        <div style={{ borderLeft: '1px solid var(--border-color)', paddingLeft: 'clamp(24px, 5vw, 40px)' }} className="mobile-no-border">
                            <p style={{ fontSize: 'clamp(1rem, 1.8vw, 1.1rem)', color: 'var(--text-muted)', lineHeight: '1.7' }}>
