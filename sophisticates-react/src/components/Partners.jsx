        ...
        <main className="smooth-scroll-wrapper" style={{ paddingTop: '160px', paddingBottom: '160px', minHeight: '100vh', background: 'var(--bg-color)', position: 'relative' }}>
            ...
            <div className="max-w-container" style={{ position: 'relative', zIndex: 2 }}>
                ...
                <div style={{ background: 'var(--nav-bg)', border: '1px solid var(--border-color)', padding: 'clamp(40px, 8vw, 80px)', textAlign: 'center' }}>
                    ...
                    <Link to="/contact" className="btn-premium hover-target" style={{ display: 'inline-block', textDecoration: 'none', padding: '16px 40px', fontSize: '0.85rem', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
