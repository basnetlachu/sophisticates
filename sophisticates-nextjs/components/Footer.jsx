        ...
        <footer style={{
            ...
            >
                ...
                <div style={{ maxWidth: '440px', width: '100%' }}>
                    <Link href="/" onClick={() => window.scrollTo(0, 0)} className="hover-target">
                        <motion.img
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: 'clamp(32px, 5vw, 80px)', width: '100%', maxWidth: '600px' }}>
                    ...
                    <div>
                        ...
                        <nav style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
                            <Link className="hover-target" href="/privacy" style={{ fontSize: '1rem', color: 'var(--text-main)', opacity: 0.5, textDecoration: 'none', fontFamily: 'var(--font-body)', transition: 'all 0.4s', fontWeight: 300 }} onMouseEnter={e => { e.target.style.opacity = 1; e.target.style.transform = 'translateX(8px)' }} onMouseLeave={e => { e.target.style.opacity = 0.5; e.target.style.transform = 'translateX(0)' }}>Privacy Policy</Link>
                            <Link className="hover-target" href="/terms" style={{ fontSize: '1rem', color: 'var(--text-main)', opacity: 0.5, textDecoration: 'none', fontFamily: 'var(--font-body)', transition: 'all 0.4s', fontWeight: 300 }} onMouseEnter={e => { e.target.style.opacity = 1; e.target.style.transform = 'translateX(8px)' }} onMouseLeave={e => { e.target.style.opacity = 0.5; e.target.style.transform = 'translateX(0)' }}>Terms of Service</Link>
                        </nav>
                    </div>
                </div>
            </div>
